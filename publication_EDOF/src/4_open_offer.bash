curl 'https://www.of.moncompteformation.gouv.fr/edof-api/v1/api/private/trainings/#ID#/actions/01/sessions/01?wantedStatus=ACTIVE&wantedRecruitmentStatus=OPENED' \
  -X 'PUT' \
  ...
  --data-raw '{"shortId":"01","id":"#OUT_ID#_01","trainingShortId":"#ID#","trainingId":"#OUT_ID#_#ID#","actionShortId":"01","actionId":"#OUT_ID#_01","statusLabel":"VALIDATED","statusCode":"7","recruitmentStatusLabel":"CLOSED","recruitmentStatusCode":"2","particularities":null,"guaranteed":true,"certificationQualiopi":true,"beginDate":null,"endDate":null,"eligible":true,"authorization":true,"codeReferentiel":"CERTIFINFO"}' \
  --compressed
